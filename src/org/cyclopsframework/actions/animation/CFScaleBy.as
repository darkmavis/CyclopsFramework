...
package org.cyclopsframework.actions.animation
{
	...
	public class CFScaleBy extends CFAction
	{
		public static const TAG:String = "@CFScaleTo";
			...
			bias:Function=null)
		{
			...
			CFUtils.validate(target, "CFScaleBy target", null, true);
