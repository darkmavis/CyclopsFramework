...
package org.cyclopsframework.actions.animation
{
	...
	public class CFRotateTo extends CFAction
	{
		public static const TAG:String = "@CFRotateTo";
			...
			bias:Function=null)
		{
			...
			CFUtils.validate(target, "CFRotateTo target", null, true);
