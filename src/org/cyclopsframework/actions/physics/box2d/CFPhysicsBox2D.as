...
package org.cyclopsframework.actions.physics.box2d
{
	...
	public class CFPhysicsBox2D extends CFAction
	{
		public static const TAG:String = "@CFPhysics";
		
		//private static var _instance:CFPhysics;
		//public static function get instance():CFPhysics { return _instance; }
		...
		private var _contactListener:CFContactListenerBox2D = new CFContactListenerBox2D();
		...
		public function CFPhysicsBox2D(gravity:b2Vec2=null, targetDelta:Number=1/30, sleepingEnabled:Boolean=true)
		{
		...
		public function createSimpleActor(target:Object, radius:Number=0, density:Number=1, orientation:int=0, period:Number=Number.MAX_VALUE):CFPhysicsActorBox2D
		{
			var bodydef:b2BodyDef = new b2BodyDef();
