...
package org.cyclopsframework.starling.actions.animation
{
	...
	public class CFFadeBy extends CFAction
	{
		public static const TAG:String = "@CFFadeBy";
			...
			bias:Function=null)
		{
			...
			CFUtils.validate(target, "CFFadeBy target", null, true);
