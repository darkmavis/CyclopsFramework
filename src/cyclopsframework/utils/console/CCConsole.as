...
package cyclopsframework.utils.console
{
	...
	/**
	 * CCConsole is an extendable, scriptable console, designed to integrate well with CyclopsFramework or work equally well in stand-alone mode.<br/>
	 ...
	 * var console:CCConsole = new CCConsole(800, 600);<br/>
	 ...
	 * console.addEventListener(CCScene.EVENT_SCENE_READY, function(e:Event):void { console.println("Hello World!"); });<br/>
	 * </listing></p>
	 * <p>
	 * CCGame mode example:<br/><listing>
	 * // Assumes that a public static property 'game' (of type MyGame) exists in this hypothetical CCGame subclass, MyGame.<br/>
	 * // Using CCGame is a great way to go if you are starting from scratch.<br/>
